"""
Django settings for Cust_Note project.
...
MIDDLEWARE = [
    ...
    'Cust_Note.middleware.DisableSecurityHeadersMiddleware',
]

ROOT_URLCONF = "Cust_Note.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'Cust_Note.context_processors.debug_settings',
            ],
        },
    },
]

WSGI_APPLICATION = "Cust_Note.wsgi.application"
...
# 커스텀 유저 모델 설정
AUTH_USER_MODEL = 'Cust_User.CustomUser'
