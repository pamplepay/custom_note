...
urlpatterns = [
    ...
    path('upload-cards-excel/', views.upload_cards_excel, name='upload_cards_excel'),
    path('download-template/', views.download_template, name='download_template'),
    path('upload-customers-excel/', views.upload_customers_excel, name='upload_customers_excel'),
    path('download-customer-template/', views.download_customer_template, name='download_customer_template'),
