...
urlpatterns = [
    ...
    path('coupons/<int:coupon_id>/use/', views.use_coupon, name='use_coupon'),
    ...
    path('reset-station-selection/', views.reset_station_selection, name='reset_station_selection'),
